...
const translations: Record<string, Record<string, string>> = {
  en: {
    // v3 redesign — key sections (Hero, Trust, Pain, CTAs)
    'v3.hero.eyebrow': 'S/00 — AI-native Kubernetes platform · self-service · GitOps · MCP',
    'v3.hero.headline.0': 'The platform team <strong>is now</strong> <span class="hl-accent">an agent</span>.',
    'v3.hero.headline.1': 'The platform team you didn\'t <span class="hl-accent">have to hire</span>.',
    'v3.hero.headline.2': 'Production Kubernetes, <span class="hl-accent">day one</span>.',
    'v3.hero.headline.3': '<span class="hl-accent">kubectl</span> is the fallback now.',
    'v3.hero.headline.4': 'Run Kubernetes like a <span class="hl-accent">100-person</span> platform team.',
    'v3.hero.headline.5': 'Ship code. <span class="hl-accent">Sleep through the night.</span>',
    'v3.hero.headline.6': 'Kubernetes, <span class="hl-accent">finally civilized</span>.',
    'v3.hero.voice.eng': 'For teams that <strong>outgrew DIY DevOps</strong> but aren\'t ready to hire a platform team. MCTL is a production-grade, AI-native Kubernetes platform — GitOps, secrets, team isolation, on-call agent — built in. Sign in with GitHub, get a namespace in <strong>about two minutes</strong>.',
    'v3.hero.voice.bold': 'Sign in with GitHub, get a namespace in two minutes, ship before lunch.',
    'v3.hero.voice.editorial': 'Most product teams don\'t have a platform problem — they have a queue problem. MCTL gives you production-grade infrastructure without the headcount, and without the queue.',
    'v3.hero.cta.demo': 'Book a demo →',
    'v3.hero.cta.engineer': 'Talk to an engineer',
    'v3.hero.cta.docs': 'Read the docs',
    'v3.hero.micro.0': 'Runs on your cloud',
    'v3.hero.micro.1': 'No migration required',
    'v3.hero.micro.2': 'Setup in days, not quarters',
    'v3.hero.micro.3': 'No vendor lock-in',
    'v3.hero.stat.0': 'MCP tools',
    'v3.hero.stat.1': 'AI clients',
    'v3.hero.stat.2': 'Self-healing agent',
    'v3.hero.stat.3': 'Tickets for routine work',
    'v3.trust.lab': 'Built on, not instead of',
    'v3.trust.sub': 'Boring, battle-tested OSS — wired together, kept current.',
    'v3.pain.label': 'Pain',
    'v3.pain.title': 'When Kubernetes starts <em>slowing you down.</em> <em>You probably hit two of these in the last sprint.</em>',
    'v3.pain.c1.tag': 'deployments',
    'v3.pain.c1.title': 'Deploys are fragile, and one person knows why.',
    'v3.pain.c1.body': 'Helm values diverge across staging and prod. Rollbacks are a Slack thread. The bus factor is, generously, two.',
    'v3.pain.c2.tag': 'drift',
    'v3.pain.c2.title': 'Staging and prod don’t match — and you know it.',
    'v3.pain.c2.body': '“What’s in production” is a question someone has to answer with kubectl. Manifests live in three places.',
    'v3.pain.c3.tag': 'tickets',
    'v3.pain.c3.title': 'Every namespace, secret and domain is a ticket.',
    'v3.pain.c3.body': 'Devs wait on DevOps for trivial work. DevOps becomes a queue. Preview environments become a luxury.',
    'v3.pain.c4.tag': 'tooling',
    'v3.pain.c4.title': 'CI, CD and observability are glued together by hand.',
    'v3.pain.c4.body': 'Five repos, four dashboards, three secret stores. New hires take a sprint just to deploy a hello world.',
    'v3.pain.c5.tag': 'hiring → cost',
    'v3.pain.c5.title': 'Hiring a platform team is too early, or too expensive.',
    'v3.pain.c5.body': 'Two SREs at $250k each, six months to a v1, eighteen to feature parity with the OSS you already run. The math is not loving.',
    'v3.pain.c6.tag': 'where this goes',
    'v3.pain.c6.title': 'You ship slower the bigger you get.',
    'v3.pain.c6.body': 'Eventually someone says "maybe we shouldn\'t be doing this ourselves." That\'s the conversation MCTL is built for.',
    'v3.pain.cta': 'See how MCTL fixes this',
    'v3.midcta.text': 'Want to see this on your stack?',
    'v3.midcta.em': 'Bring a service, a cluster, and 30 minutes — we\'ll deploy it live.',
    'v3.midcta.demo': 'Book a demo',
    'v3.midcta.engineer': 'Talk to an engineer',
    'v3.cta.label': 'Get started',
    'v3.cta.heading': 'Stop triaging. <em>Start shipping.</em>',
    'v3.cta.body': 'Invite-only beta. Sign in with GitHub, pick a team name, tell us what you\'ll build — your namespace is provisioned in about two minutes.',
    'v3.cta.github': 'Sign in with GitHub',
    'v3.cta.docs': 'Read the docs',
    'v3.cta.mcp': 'Connect MCP',
    'v3.cta.micro': 'No credit card · No platform team required · You can leave any time — your repos are yours.',
    ...
    // Hero
    'hero.badge': 'Self-service Kubernetes platform',
    ...
    'pricing.custom.note': 'Outgrowing the free tier?',
    'pricing.custom.cta': 'Talk to us about a custom plan',
  ...
  ru: {
    // v3 redesign — key sections (Hero, Trust, Pain, CTAs)
    'v3.hero.eyebrow': 'S/00 — AI-native платформа Kubernetes · self-service · GitOps · MCP',
    'v3.hero.headline.0': 'Платформенная команда <strong>теперь</strong> <span class="hl-accent">агент</span>.',
    'v3.hero.headline.1': 'Платформенная команда, которую <span class="hl-accent">не пришлось нанимать</span>.',
    'v3.hero.headline.2': 'Продакшен-Kubernetes <span class="hl-accent">с первого дня</span>.',
    'v3.hero.headline.3': '<span class="hl-accent">kubectl</span> теперь — запасной вариант.',
    'v3.hero.headline.4': 'Управляйте Kubernetes как <span class="hl-accent">команда из 100 человек</span>.',
    'v3.hero.headline.5': 'Деплойте код. <span class="hl-accent">Спите спокойно.</span>',
    'v3.hero.headline.6': 'Kubernetes, <span class="hl-accent">наконец-то цивилизованный</span>.',
    'v3.hero.voice.eng': 'Для команд, которые <strong>переросли DIY-DevOps</strong>, но ещё не готовы нанимать платформенную команду. MCTL — продакшен-готовая AI-native платформа Kubernetes: GitOps, секреты, изоляция команд и дежурный агент — из коробки. Войдите через GitHub и получите namespace <strong>примерно за две минуты</strong>.',
    'v3.hero.voice.bold': 'Войдите через GitHub, получите namespace за две минуты и зарелизьте до обеда.',
    'v3.hero.voice.editorial': 'У большинства продуктовых команд не проблема с платформой — у них проблема с очередью. MCTL даёт продакшен-инфраструктуру без расширения штата и без очереди.',
    'v3.hero.cta.demo': 'Заказать демо →',
    'v3.hero.cta.engineer': 'Поговорить с инженером',
    'v3.hero.cta.docs': 'Документация',
    'v3.hero.micro.0': 'Работает в вашем облаке',
    'v3.hero.micro.1': 'Без миграции',
    'v3.hero.micro.2': 'Запуск за дни, а не кварталы',
    'v3.hero.micro.3': 'Без привязки к вендору',
    'v3.hero.stat.0': 'MCP-инструментов',
    'v3.hero.stat.1': 'AI-клиентов',
    'v3.hero.stat.2': 'Самовосстанавливающийся агент',
    'v3.hero.stat.3': 'Тикетов на рутину',
    'v3.trust.lab': 'Поверх, а не вместо',
    'v3.trust.sub': 'Скучный, проверенный в бою OSS — связанный воедино и поддерживаемый в актуальном состоянии.',
    'v3.pain.label': 'Боль',
    'v3.pain.title': 'Когда Kubernetes начинает <em>вас тормозить.</em> <em>Вы наверняка ловили два из этих за последний спринт.</em>',
    'v3.pain.c1.tag': 'деплои',
    'v3.pain.c1.title': 'Деплои хрупкие, и только один человек знает почему.',
    'v3.pain.c1.body': 'Helm-значения расходятся между staging и prod. Откат — это тред в Slack. Bus factor, в лучшем случае, два.',
    'v3.pain.c2.tag': 'дрифт',
    'v3.pain.c2.title': 'Staging и prod не совпадают — и вы это знаете.',
    'v3.pain.c2.body': '«Что сейчас в проде» — вопрос, на который кто-то отвечает через kubectl. Манифесты живут в трёх местах.',
    'v3.pain.c3.tag': 'тикеты',
    'v3.pain.c3.title': 'Каждый namespace, секрет и домен — это тикет.',
    'v3.pain.c3.body': 'Разработчики ждут DevOps по мелочам. DevOps превращается в очередь. Preview-окружения становятся роскошью.',
    'v3.pain.c4.tag': 'тулинг',
    'v3.pain.c4.title': 'CI, CD и наблюдаемость склеены вручную.',
    'v3.pain.c4.body': 'Пять репозиториев, четыре дашборда, три хранилища секретов. Новичку нужен спринт, чтобы задеплоить hello world.',
    'v3.pain.c5.tag': 'найм → деньги',
    'v3.pain.c5.title': 'Нанимать платформенную команду — слишком рано или слишком дорого.',
    'v3.pain.c5.body': 'Два SRE по $250k, полгода до v1, восемнадцать месяцев до паритета с OSS, который у вас уже работает. Математика не радует.',
    'v3.pain.c6.tag': 'к чему всё идёт',
    'v3.pain.c6.title': 'Чем больше вы растёте, тем медленнее релизите.',
    'v3.pain.c6.body': 'Рано или поздно кто-то говорит: «может, не стоит делать это самим». Именно для этого разговора создан MCTL.',
    'v3.pain.cta': 'Посмотреть, как MCTL это решает',
    'v3.midcta.text': 'Хотите увидеть это на своём стеке?',
    'v3.midcta.em': 'Принесите сервис, кластер и 30 минут — задеплоим вживую.',
    'v3.midcta.demo': 'Заказать демо',
    'v3.midcta.engineer': 'Поговорить с инженером',
    'v3.cta.label': 'Начать',
    'v3.cta.heading': 'Хватит разгребать. <em>Начните релизить.</em>',
    'v3.cta.body': 'Бета по приглашениям. Войдите через GitHub, выберите имя команды, расскажите, что будете строить — namespace создаётся примерно за две минуты.',
    'v3.cta.github': 'Войти через GitHub',
    'v3.cta.docs': 'Документация',
    'v3.cta.mcp': 'Подключить MCP',
    'v3.cta.micro': 'Без карты · Без платформенной команды · Уйти можно в любой момент — ваши репозитории остаются вашими.',
    ...
    // Hero
    'hero.badge': 'Self-service \u043f\u043b\u0430\u0442\u0444\u043e\u0440\u043c\u0430 Kubernetes',
    ...
    'hero.cta_secondary': '\u0414\u043e\u043a\u0443\u043c\u0435\u043d\u0442\u0430\u0446\u0438\u044f',
    ...
    'pricing.custom.note': '\u041f\u0435\u0440\u0435\u0440\u0430\u0441\u0442\u0430\u0435\u0442\u0435 \u0431\u0435\u0441\u043f\u043b\u0430\u0442\u043d\u044b\u0439 \u0442\u0430\u0440\u0438\u0444?',
    'pricing.custom.cta': '\u041e\u0431\u0441\u0443\u0434\u0438\u0442\u044c \u0438\u043d\u0434\u0438\u0432\u0438\u0434\u0443\u0430\u043b\u044c\u043d\u044b\u0439 \u043f\u043b\u0430\u043d',
